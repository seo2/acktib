...
/*
		add_image_size('home_programas', 255, 310, true); 
		add_image_size('home_cortos', 482, 398, true); 
		add_image_size('header_programa', 1200, 250, true); 
		add_image_size('lista_capitulo', 350, 200, true);
*/ 
...
/* INCLUIR SCRIPTS */
	...
	function incluirScripts(){
		...
		wp_enqueue_style( 'swal', get_template_directory_uri() . '/assets/css/sweetalert.css', array(), '2.4', 'screen' );
		...
		wp_enqueue_script( 'form_js', 'http://malsup.github.com/jquery.form.js', array('jquery'), '3.51.0', true );
		wp_enqueue_script( 'swal_js', get_template_directory_uri() . '/assets/js/sweetalert.min.js', array('jquery'), '1.6.5', true );
